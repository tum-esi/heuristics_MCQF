...
from GaSaAlgorithm import (load_graph_stream_data, process_graph_data, process_flow_data,
                              reset_global_cache, E2E_objective)


RUNNAME = '1gbps GASA-TI 125 250 500 ER'
from time import time

if __name__ == '__main__':

    for i in [2, 3, 4, 5, 7, 13, 19, 28, 29]:  # ring
        ...
        date_and_hour = now.strftime("_%Y-%m-%d_%H-%M-%S_50_125_250_1Gbits_GASA")
